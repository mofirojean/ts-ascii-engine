 ...
 */
export function extractPixelData(source, targetWidth, targetHeight) {
    ...
    if (source instanceof HTMLCanvasElement) {
        ...
        sourceWidth = source.width || source.videoWidth || 0;
        sourceHeight = source.height || source.videoHeight || 0;
    }
    ...
    try {
        ...
        if (err instanceof DOMException && err.name === 'SecurityError') {
            throw new Error('Cannot extract pixel data from cross-origin image. ' +
 ...
 */
export function luminanceToChar(luminance, charset, inverted = false) {
 ...
 */
export function calculateDimensions(sourceWidth, sourceHeight, targetWidth, targetHeight, aspectRatio = 0.55) {
 ...
 */
export function renderTextToCanvas(text, font = 'Arial', fontSize = 48, fontWeight = 'normal', fontStyle = 'normal', color = '#000000', backgroundColor = '#ffffff', padding = 10) {
 ...
 */
export function samplePixelColor(pixelData, gridX, gridY, gridWidth, gridHeight) {
 ...
 */
export function rgbToCSS(r, g, b, a = 255) {
