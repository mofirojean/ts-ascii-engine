 ...
 */
// Core engine
export { AsciiGenerator } from './core/ascii-engine.js';
export { CharsetPreset, CHARSET_MAP } from './types/interfaces.js';
// Utility functions (for advanced use cases)
export { extractPixelData, calculateLuminance, luminanceToChar, calculateDimensions, renderTextToCanvas, samplePixelColor, rgbToCSS } from './utils/canvas-helpers.js';
/**
 * @example Basic Usage
 * ```typescript
